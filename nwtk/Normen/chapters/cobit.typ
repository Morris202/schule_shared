...
== Kurze Einführung in IT-Governance 
...
- *Stakeholder-Orientierung:*  
  COBIT richtet sich nach den Bedürfnissen aller beteiligten Gruppen, wie Führungskräften, IT-Mitarbeitern und Endnutzern. Interessenkonflikte der Stakeholder sollen dabei aufgedeckt und angepasst werden. 
  
- *Abdeckung der gesamten Unternehmens-IT:*  
  Mit COBIT wird die IT in Kombination mit der restlichen Unternehmensführung geführt. Das bedeutet, dass IT kein eigener Teil des Unternehmens mehr ist. Dadurch werden IT-Prozesse und Investitionen übersichtlicher und einfacher zu verwalten.
  
- *Einziges integriertes Framework:*  
  COBIT ist ein einheitliches integriertes Framework. Das bedeutet, dass es am besten ist, wenn es als alleine als Framework verwendet wird. Es ist an die modernsten Standards angepasst und bietet somit eine einfache Struktur, die eine gute Basis bildet, um Führung und Managment miteinander zu verknüpfen.
  
- *Ganzheitlicher Ansatz:*  
  Durch COBIT kann ein ganzheitlicher Ansatz ermöglicht werden. Das bedeutet, dass die IT in ihrer Gesamtheit betrachtet wird und die Integration zwischen einzelnen Bereichen im Unternehmen maximiert wird. Dabei setzt COBIT auf 7 Enabler siehe @enabler.
  
- *Trennung von Führung und Verwaltung:*  
  bei der Strukturierung unterscheidet COBIT klar zwischen Verwaltung und Führung. Diese beiden haben unterschiedliche Aufgaben, weswegen sie unterschiedliche Strukturen benötigen.
...
- *Prozesse*: Strukturierte Reihenfolge von Aktivitäteten, die zum Erreichen der Ziele benötigt werden. 
...
- *Kultur, Ethik und Verhalten*: Werte, Normen und Verhaltensweisen innehalb des Unternehmens. Eine positive Unternehmenskultur unterstützt die Umsetzung von Richtlinien.
...
- *COBIT 4.x:*  
  Diese Version war weit verbreitet, bevor COBIT 5 eingeführt wurde.
  
- *COBIT 5:*  
  Diese Version integrierte Governance und Management und legte besonderen Wert auf die Bedürfnisse der Stakeholder.
  
- *COBIT 2019:*  
  Die aktuelle Version bietet mehr Flexibilität und Anpassungsmöglichkeiten, um modernen IT-Herausforderungen gerecht zu werden.


== Wie funktioniert COBIT in der Praxis?
...
COBIT beinhaltet mehr als 40 Governance- und Führungsziele, welche von IT-Managern unterschiedlich priorisiert oder sogar ausgelassen werden können. Diese Ziele können gruppiert werden. Dafür sind die Domänen zuständig. Jede Domäne ist ein Geschäftsprozess wie Planung, Design oder Überwachung. Komponenten (Enabler siehe @enabler) sollen durch das Framework kontinuierlich verbessert werden, da sie die IT beeinflussen. Designfaktoren helfen dabei, Bedürfnisse von Organisationen zu erkennen. Anhand dieser Faktoren werden Entscheidungen über Technologie, Methoden und Outsourcing getroffen.  
