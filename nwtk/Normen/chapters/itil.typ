...
#figure(
  image("../figures/ITIL_Geschichte.png", width: 90%),
...
#figure(
  image("../figures/ITIL_SVS.png", width: 80%),
  caption: [ITIL SVS],
)
...
#figure(
  image("../figures/ITIL_Grundprinzipien.png", width: 90%),
  caption: [Grundprinzipien des ITIL],
)
...
#figure(
  image("../figures/ITIL_4DModell.png", width: 80%),
  caption: [ITIL vier Dimensionenmodell],
)
...
#figure(
  ...
  caption: [Zertifizierungsprozess des ITIL],
)

== Kritik
Laut einer Studie, in der über 300 mittelständische Unternehmen befragt wurden, hielten die Unternehmen die ITIL äußerst hilfreichh, aber für Mittel- und Kleinunternehmen zu komplex. Die Prozesse seien nicht für kleinere Unternehmen angelegt, da sie zu methodisch und zu langwierig sind. (Light Version für KMUs)